...
// v1.0.20: extension 폴더명에 버전 박제 — postinstall.ts 의 AUTO_CHROME_MCP_EXT_DIR 과 동일 규약.
//   manifest 의 version 을 직접 읽어 어긋남 방지.
const EXTENSION_VERSION = chrome.runtime.getManifest().version;
const COMMANDS = {
  // 메인 npm 설치 — postinstall 이 manifest 등록 + extension zip 다운로드 자동 수행
  npmInstall: 'npm install -g auto-chrome-mcp-bridge',
...
3. 확인 후 Esc 로 빠져나오기`,
  ...
  // GitHub repo
  repoUrl: 'https://github.com/cw02326/auto-chrome-mcp',
  ...
  extensionPath: `~/Downloads/auto-chrome-mcp-extension-v${EXTENSION_VERSION}/`,
} as const;
          ...
          <section v-if="activePath === 'npm'" class="welcome-card welcome-card--primary p-6">
            ...
            <p class="welcome-muted text-sm mt-2">
              <code class="welcome-code welcome-code-inline px-1 py-0.5"
                >npm install -g auto-chrome-mcp-bridge</code
              >
            ...
            <ul class="welcome-checklist mt-3 space-y-1.5 text-sm">
              ...
              <li
                >✅ Native Messaging manifest 등록 (<code class="welcome-code"
                  >com.autochromemcp.nativehost</code
                >)</li
              >
              <li
                >✅ Extension zip 다운로드 →
            ...
            >
              ...
              <p class="welcome-subtle text-xs mt-4">
                troubleshooting 스킬 (
                <code class="welcome-code welcome-code-inline px-1 py-0.5"
                  >~/.claude/skills/auto-chrome-mcp-doctor/</code
                >
                ...
                <li class="welcome-step">
                  ...
                  <div class="min-w-0">
                    ...
                    <p class="welcome-subtle text-xs mt-2">
                      ...
                      <code class="welcome-code welcome-code-inline px-1 py-0.5"
                        >com.autochromemcp.nativehost.json</code
                      >
                      배치. Node.js 20+ 필요 —
