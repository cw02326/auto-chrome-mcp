...
/**
 * scalemaker fork extension ID (deterministic — derived from manifest.key in wxt.config.ts).
...
export const DESCRIPTION = 'Node.js Host for Browser Bridge Extension (mcp-chrome-scalemaker)';
