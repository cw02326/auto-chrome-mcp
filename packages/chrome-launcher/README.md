...
> Chrome launcher with `--remote-debugging-port=9222` for [mcp-chrome-scalemaker](https://github.com/scalemaker-ship-it/mcp-chrome-scalemaker) Playwright CDP fallback.
